...
<body>
  ...
  <header id="header" class="d-flex align-items-center header-inner-pages">
    <div class="container-fluid d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html"><img src="resources/logo_marbella.png" /></a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index.html#about">Sobre Marbella</a></li>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <p>
          Para reservar en Marbella, rellene el siguiente formulario y un asesor se pondrá en contacto con usted para
            ...
            <div class="row">
              <div class="col-md-6 form-group">
                <select class="form-control" name="zonas">
                  ...
                  <option class="form-control" name="zonas" value="3" id="ext">Exterior</option>
                </select>
              </div>
              <div class="col-md-6 form-group">
            ...
            <div class="row separacionHawai">
              ...
              <div class="col-md-8 form-group mt-3 mt-md-0">
                <select class="form-control" name="hora">
                  ...
                  <option class="form-control" name="hora" id="1530" value="20:00">20:00</option>
                  <option class="form-control" name="hora" id="1530" value="20:30">20:30</option>
                  <option class="form-control" name="hora" id="1530" value="21:00">21:00</option>
                  <option class="form-control" name="hora" id="1530" value="21:30">21:30</option>
                  <option class="form-control" name="hora" id="1530" value="22:00">22:00</option>
                  <option class="form-control" name="hora" id="1530" value="22:30">22:30</option>
                </select>
              </div>
          </div>
          <!-- class separacion-->
        ...
        <div class="row">
            <div class="col-md-4">
                <input type="tel" class="form-control" name="telefono" id="telefono" placeholder="Tu telefono" required maxlength="9"/>
            </div>
            <div class="col-md-8 form-group mt-3 mt-md-0">
