...
<html>
    ...
    <body>
        ...
        <div class="sinReserva">
            <img class="gato-sinReserva" src='../Homes/Home/images/gato-sin-reserva.gif' alt='gato sin reserva' title='gato sin reserva'/>
            <h1 class="h1-sinReserva">Lo sentimos pero usted no dispone de ninguna reserva</h1>
        </div>
        <?php
